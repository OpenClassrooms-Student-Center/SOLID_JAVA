...
public class GameSwing implements GameViewable {
    ...
    static char instanceNum = '0';

    public GameSwing () {
    	instanceName = instanceNum++;
    }
	...
	private void appendText (String text) {
		textArea.append(instanceName + ": " + text + "\n");
	...
	public void promptForPlayerName() {
		System.out.println(instanceName + ": " + "Enter Player Name:");
	...
	public void promptForFlip() {
		System.out.println(instanceName + ": " + "Press enter to reveal cards");
	...
	public void promptForNewGame() {
		System.out.println(instanceName + ": " + "Press enter to deal again");
